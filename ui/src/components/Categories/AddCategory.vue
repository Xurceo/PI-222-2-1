<template>
  <div class="flex-1/2">
    ...
    <div class="form m-10">
      <input class="bg-white hover:bg-neutral-200 duration-300 text-black h-12  w-96 p-2 m-1 border-gray-600 border-2 rounded-lg" v-model="name" type="text" placeholder="EnterName" />
      <select class="bg-white hover:bg-neutral-200 duration-300 text-black h-12 p-2 border-gray-600 border-2 rounded-lg select" v-model="parentId">
